...
// Post anonymous comments for blogpost. Url like api/blogs/:id/comments
...
blogsRouter.get('/:id/comments', async (request, response, next) => {
    ...
    const chosenFields = comms.filter(i => i.id === request.params.id)
    response.json(chosenFields.map(c => c.toJSON()))
})
